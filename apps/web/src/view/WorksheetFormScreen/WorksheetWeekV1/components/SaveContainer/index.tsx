...
import { IWorksheetFormBaseProps } from '@view/WorksheetFormScreen/types'

interface ISaveContainerProps extends IWorksheetFormBaseProps {
...
const SaveContainer: Component<ISaveContainerProps> = (props) => {
    ...
    const handleClickSaveButton = async () => {
        ...
        try {
            setSaving(true)
            const result = await saveWorksheetWeekUseCase(props.worksheet)

            props.saveDraft(result, true)
    ...
    const handleClickDuplicateButton = async () => {
        ...
        try {
            ...
            const result = await saveWorksheetWeekUseCase(duplicated)
